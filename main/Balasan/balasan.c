...
// addressTree Alokasi(Balasan data){
//     addressTree P = (addressTree) malloc(sizeof(NodeTree));
//     if(P != NULL){
//         Data(P) = data;
//         FirstChild(P) = NULL;
//         NextSibling(P) = NULL;
...
//     return P;
// }
// void searchBalas(int id, addressTree root, addressTree* hasil){
//     if (root!=NULL){
//         if (root->nextSibling!=NULL){
//             searchBalas(id,root->nextSibling,hasil);
//         }
//         if (root->firstChild!=NULL){
//             searchBalas(id,root->firstChild,hasil);
//         }
//         if (root->data.id==id){
//             *hasil = root;
//         }
...
// void balas(ListKicau* kList, int IdKicau, int IdBalas,Account akunLogin, AccountList akun, Graf teman){
//     boolean isFound = false;
//     Word privat = {"Privat", 6};
//     int i;
//     for (i = 0; (i < kList->nEff) && (!isFound); i++)
//     {
//         if (kList->kicau[i].id == IdKicau)
//         {
//             isFound = true;
//         }
//     }
...
//     else
//     {
//         kicau k = kList->kicau[i];
//         addressTree nodeBalas = NULL;
//         searchBalas(IdBalas,kList->kicau[i].balas->root,&nodeBalas);
//         if (nodeBalas==NULL){
//             printf("Wah, tidak terdapat balasan yang ingin Anda balas!\n");
//         }else{
//             int j;
//             isFound = false;
//             for (j=0;j<akun.count && !isFound;j++){
//                 if (WordEqual(akun.accounts[j].username[0],kList->kicau[i].author)){
//                     isFound = true;
//                 }
//             } 
//             j -= 1;
//             int idPembalas = j;
//             for (i = 0; !WordEqual(akunLogin.username[0], akun.accounts[i].username[0]); i++)
//             ;
//             int idUser = i;
//             int idTeman = j;
//             if (WordEqual(akun.accounts[j].jenisAkun[0],privat) && ELMTGRAF(teman, idUser, idTeman) == 0){
